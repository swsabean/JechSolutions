...
\Exercise{13} A limit ordinal $\gamma > 0$ is indecomposable if and only if 
...
\Exercise{14} If $E$ is a well-founded relation on $P$, then there is no 
...
\Exercise{15} \textbf{(Well-Founded Recursion).} Let $E$ be a well-founded 
