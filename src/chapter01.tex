...
\Exercise{11} $\N$ is T-infinite; the set $\N \subset P(\N)$ has no 
...
\Exercise{12} Every finite set is T-finite.
\begin{solution}
...
\Exercise{13} Every infinite set is T-infinite. [If $S$ is infinite, consider 
...
\Exercise{14} The Separation Axioms follow from the Replacement Schema. [Given 
...
\Exercise{15} Instead of Union, Power Set, and Replacement Axioms 
